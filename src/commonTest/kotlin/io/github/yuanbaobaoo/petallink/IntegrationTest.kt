...
class IntegrationTest {
    ...
    fun Reconciliation_rekeySubtree正确重映射路径() {
        val tree = mutableMapOf(
            "dir/file.txt" to io.github.yuanbaobaoo.petallink.drive.DriveFile(id = "fid1", name = "file.txt"),
            "dir/sub/inner.txt" to io.github.yuanbaobaoo.petallink.drive.DriveFile(id = "fid2", name = "inner.txt"),
        )
