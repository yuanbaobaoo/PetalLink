...
REM PetalLink keeps Kotlin Toolchain outputs separate from legacy Gradle packaging outputs.
if not defined AMPER_BUILD_DIR set AMPER_BUILD_DIR=%~dp0.kotlin\build
