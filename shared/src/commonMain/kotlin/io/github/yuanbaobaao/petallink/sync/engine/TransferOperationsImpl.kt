...
import io.github.yuanbaobaao.petallink.drive.UploadProtocol
import io.github.yuanbaobaao.petallink.drive.validatedResponseOffset
        ...
        try {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    position += count
                    progress.report(position, io.github.yuanbaobaao.petallink.drive.PlatformTime.millis())
                }
                break
            }
