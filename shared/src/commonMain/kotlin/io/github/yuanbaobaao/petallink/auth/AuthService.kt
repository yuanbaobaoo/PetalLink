...
class AuthService(
    ...
    suspend fun exchangeCodeForToken(
        ...
        val token = TokenPair.fromResponse(
            ...
            tokenType = tokenType,
            scope = scope,
            nowMs = io.github.yuanbaobaao.petallink.drive.PlatformTime.millis(),
        )
    ...
    suspend fun ensureValidAccessToken(): String {
        ...
        if (token.willExpireWithin(AuthConstants.TOKEN_EXPIRY_BUFFER_SECS, io.github.yuanbaobaao.petallink.drive.PlatformTime.millis())) {
