...
object Reconciliation {
     ...
     */
    fun rekeySubtree(
        tree: MutableMap<String, io.github.yuanbaobaao.petallink.drive.DriveFile>,
    ...
    fun applyChangesToCandidate(
        changes: List<io.github.yuanbaobaao.petallink.drive.DriveChange>,
        tree: MutableMap<String, io.github.yuanbaobaao.petallink.drive.DriveFile>,
        pathToId: MutableMap<String, String>,
        rootFolderId: String?,
    ) {
        ...
        for (change in changes) {
            ...
            when (change.kind) {
                io.github.yuanbaobaao.petallink.drive.ChangeKind.REMOVED -> {
                ...
                io.github.yuanbaobaao.petallink.drive.ChangeKind.MODIFIED -> {
